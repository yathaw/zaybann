	  ...
	  <div class="card shadow mb-4">
		<div class="card-header py-3">
			<div class="row">
					...
					<div class="col-2">
						<a href="subcategory_list" class="btn btn-outline-primary btn-block float-right"> 
        ...
        <div class="card-body">
            <form action="subcategory_add" method="POST">
				...
				<div class="form-group row">
			    	...
			    	<div class="col-sm-10">
			      		<input type="text" class="form-control" id="categoryName" placeholder="Enter Sub-category Name" name="name">
			    	</div>
				</div>
